...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#choose-us-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.choose-us-section.add')
    @include('admin.components.modals.site-section.choose-us-section.edit')
...
@push('script')
    ...
    <script>
        openModalWhenError("choose-us-add","#choose-us-add");
        openModalWhenError("choose-us-edit","#choose-us-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            openModalBySelector("#choose-us-edit");
