        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#how-its-work-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add New Item") }}</a>
                </div>
            </div>
                            ...
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>
                                    @include('admin.components.form.switcher',[
                                        'name'        => 'how_its_work_status',
                                        'value'       => $item->status,
                                        'options'      => [__('Enable') => 1, __('Disable') => 0],
                                        'onload'      => true,
                                        'data_target' =>  $item->id,
                                        'permission'  => "admin.setup.sections.howitswork.status.update",
                                    ])
                                </td>
                                <td>
...
@push('script')
<script>
    openModalWhenError("how-its-work-add","#how-its-work-add");
    openModalWhenError("how-its-work-edit","#how-its-work-edit");
    ...
    $(".edit-modal-button").click(function(){
        ...
        var editModal = $("#how-its-work-edit");
        console.log(oldData);
        ...
        openModalBySelector("#how-its-work-edit");
    });
    ...
    $(document).ready(function(){
        // Switcher
        switcherAjax("{{ setRoute('admin.setup.sections.howitswork.status.update',$slug) }}");
    })
</script>
@endpush
