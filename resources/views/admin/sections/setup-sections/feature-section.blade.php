...
@section('content')
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                ...
                                                'label_after'   => "*",
                                                'name'          => $item->code . "_first_heading",
                                                'value'         => old($item->code . "_first_heading",$data->value->language->$lang_code->first_heading ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.textarea',[
                                                'label'         => __("First Sub Heading"),
                                                'label_after'   => "*",
                                                'name'          => $item->code . "_first_sub_heading",
                                                'value'         => old($item->code . "_first_sub_heading",$data->value->language->$lang_code->first_sub_heading ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                ...
                                                'label_after'   => "*",
                                                'name'          => $item->code . "_second_heading",
                                                'value'         => old($item->code . "_second_heading",$data->value->language->$lang_code->second_heading ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.textarea',[
                                                'label'         => __("Second Sub Heading"),
                                                'label_after'   => "*",
                                                'name'          => $item->code . "_second_sub_heading",
                                                'value'         => old($item->code . "_second_sub_heading",$data->value->language->$lang_code->second_sub_heading ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#feature-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add New Feature") }}</a>
                </div>
            </div>
                            ...
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>
                                    @include('admin.components.form.switcher',[
                                        ...
                                        'onload'      => true,
                                        'data_target' =>  $item->id,
                                        'permission'  => "admin.setup.sections.feature.status.update",
                                    ])
                                </td>
                                <td>
    ...
    @include('admin.components.modals.site-section.feature-section.add')
    @include('admin.components.modals.site-section.feature-section.edit')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        // Switcher
        switcherAjax("{{ setRoute('admin.setup.sections.feature.status.update',$slug) }}");
    })
</script>
@endpush