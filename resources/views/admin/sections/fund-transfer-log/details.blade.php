        ...
        <div class="card-body">
            <form class="card-form">
                <div class="row align-items-center mb-10-none">
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list-two">
                            <li class="two">{{ __("Email") }} : <span>{{ $transaction->receiver_info->email }}</span></li>
                            <li class="three">{{ __("Account No") }} : <span>{{ $transaction->receiver_info->account_no }}</span></li>
                            <li class="four">{{ __("Amount") }} : <span>{{ get_amount($transaction->request_amount,$transaction->creator_wallet->currency->code) }}</span></li>
                        </ul>
                    </div>
                    <div class="col-xl-4 col-lg-4 form-group">
                        <div class="user-profile-thumb">
                            <img src="{{ get_image($transaction->receiver_info->image,'user-profile') }}" alt="payment">
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list two">
