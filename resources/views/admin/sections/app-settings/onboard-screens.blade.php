    ...
    <script>
        ...
        $(".onboard-screen-edit-modal-btn").click(function(){
            ...
            $.each(languages,function(index,item){
                editModal.find("input[name="+item.code+"_heading]").val((oldData.heading.language[item.code] == undefined ) ? '' : oldData.heading.language[item.code].heading);
                ...
                editModal.find("input[name="+item.code+"_details]").val((oldData.details.language[item.code] == undefined ) ? '' : oldData.details.language[item.code].details);
