            ...
            <tr>
                ...
                <td>
                    @if ($item->status == payment_gateway_const()::STATUSPENDING)
                        <form method="POST" action="{{ route('admin.fund.transfer.log.approve') }}" style="display:inline-block;margin:0 2px;">
                            @csrf
                        ...
                        <form method="POST" action="{{ route('admin.fund.transfer.log.reject') }}" style="display:inline-block;margin:0 2px;">
                            @csrf
                            <input type="hidden" name="target" value="{{ $item->trx_id }}">
