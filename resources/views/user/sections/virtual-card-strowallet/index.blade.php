...
@section('content')
    ...
    <div class="row mb-30-none justify-content-center">
        <div class="col-xxl-7 col-xl-8 col-lg-8 col-md-10 overflow-hidden  mb-30">
                            ...
                            <div class="dash-payment-item-wrapper">
                                <div class="dash-payment-item active">
                                    <div class="card-header-btn-wrapper d-flex align-items-center justify-content-between">
                                        ...
                                        @php
                                            $live_card_data = card_details($myCard->card_id,$cardApi->config->strowallet_public_key,$cardApi->config->strowallet_url);
                                        @endphp
