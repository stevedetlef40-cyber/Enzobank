                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form--control prepend" placeholder="{{ __('Enter Phone Number') }}" value="{{ $user->mobile ?? "" }}"/>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 form-group">
                                ...
                                <div class="col-xl-12 col-lg-12 form-group">
                                    @include('admin.components.form.input-file', [
                                        'label'         => __("ID Card Image (Front Side)")." "."<span class='text--base'>* (" . __("NID/Passport") . ")</span>",
                                        'name'          => "id_image_font",
                                        'class'         => "form--control",
                                        'label_class'   => "mw-100"
                                    ])
                                ...
                                <div class="col-xl-12 col-lg-12 form-group">
                                    @include('admin.components.form.input-file', [
                                        'label'         => __("Your Photo")." "."<span class='text--base'>* (" . __("Should show your face and must match with your ID") . ")</span>",
                                        'name'          => "user_image",
                                        'class'         => "form--control",
                                        'label_class'   => "mw-100"
                                    ])
