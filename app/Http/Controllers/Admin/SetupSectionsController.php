...
class SetupSectionsController extends Controller
{
    ...
    public function securityItemStore(Request $request, $slug)
    {
        ...
        if ($validator->fails()) {
            return back()->withErrors($validator)->withInput()->with('modal', 'security-add');
        }
    ...
    public function overviewItemStore(Request $request, $slug)
    {
        ...
        if ($validator->fails()) {
            return back()->withErrors($validator)->withInput()->with('modal', 'overview-add');
        }
        $validated = $validator->validate();
    ...
    public function chooseUsItemStore(Request $request, $slug)
    {
        ...
        if ($validator->fails()) {
            return back()->withErrors($validator)->withInput()->with('modal', 'choose-us-add');
        }
        $validated = $validator->validate();
    ...
    public function clientsFeedbackItemStore(Request $request, $slug)
    {
        ...
        if ($validator->fails()) {
            return back()->withErrors($validator->errors())->withInput()->with('modal', 'client-feedback-add');
        }
        $validated = $validator->validate();
    ...
    public function servicesItemStore(Request $request, $slug)
    {
        ...
        if ($validator->fails()) {
            return back()->withErrors($validator)->withInput()->with('modal', 'service-add');
        }
        $validated = $validator->validate();
