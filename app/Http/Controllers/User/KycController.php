...
class KycController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($basic_settings['kyc_verification'] == false) {
            return back()->with(['success' => ['Do not need to identity verification!!']]);
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($user->kyc_verified == GlobalConst::VERIFIED) {
            return back()->with(['success' => ['You are already KYC Verified User']]);
        }
