...
{
    use Authorize,CoinGate,Flutterwave,Paypal,PerfectMoney,Razorpay,SslCommerz,Stripe;
    ...
    public function gateway()
    {
        ...
        if ($this->project_currency == PaymentGatewayConst::PROJECT_CURRENCY_SINGLE) {
            ...
            if (! $default_currency) {
                throw new Exception('Project currency does not have default value.');
            }
    ...
    public function chargeCalculate($currency, $receiver_currency = null)
    {
        ...
        } elseif ($this->project_currency == PaymentGatewayConst::PROJECT_CURRENCY_SINGLE) {
